"""Small helpers for exploring NOAA Global Hourly observations."""
...
def plot_weather(cleaned: pd.DataFrame, *, station_name: str = "NOAA station") -> tuple[plt.Figure, tuple[plt.Axes, plt.Axes]]:
